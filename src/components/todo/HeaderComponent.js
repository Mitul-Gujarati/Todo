...
function HeaderComponent() {
    ...
    return (
        <header className="border-bottom border-light border-5 mb-5 p-2" style={{ backgroundColor: 'skyblue' }}>
            <div className="container">
                <div className="row">
                    <nav className="navbar navbar-expand-lg">
                        <a className="navbar-brand ms-2 fs-2 fw-bold text-black" href="/welcome/:username">MG</a>
